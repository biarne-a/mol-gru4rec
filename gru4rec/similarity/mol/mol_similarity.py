...
from gru4rec.similarity.mol.embeddings_fn import MoLEmbeddingsFn
...
class MoLSimilarity(SimilarityModule):
    ...
    def get_query_component_embeddings(
        ...
        **kwargs,
        ...
        """
        if decoupled_inference and not self._query_embeddings_fn:
    ...
    def get_item_component_embeddings(
        ...
        **kwargs,
        ...
        """
        if decoupled_inference and not self._item_embeddings_fn:
            return input_embeddings, {}
        ...
        **kwargs,
        ...
        with torch.autocast(
            ...
            if self._query_embeddings_fn:
                ...
                split_query_embeddings = split_query_embeddings.unsqueeze(1)

            if self._item_embeddings_fn:
                (
                ...
                split_item_embeddings = split_item_embeddings.unsqueeze(2)
